	...
	<Wrapper>
		<div class="mt-5">
			...
			<p>
				...
				a particularly high priority for the management of PorphyStruct. The use of the Internet
				pages of PorphyStruct is possible without any indication of personal data; however, if a
				data subject wants to use special enterprise services via our website, processing of
			...
			<p>
				...
				to PorphyStruct. By means of this data protection declaration, our enterprise would like to
			...
			<p>
				As the controller, PorphyStruct has implemented numerous technical and organizational
			...
			<h4>1. Definitions</h4>
			<p>
				The data protection declaration of PorphyStruct is based on the terms used by the European
				legislator for the adoption of the General Data Protection Regulation (GDPR). Our data
				protection declaration should be legible and understandable for the general public, as well
				as our customers and business partners. To ensure this, we would like to first explain the
				terminology used.
			</p>
			...
			<p>Jens Krumsieck</p>
			<p>Celler Str. 108</p>
			<p>38114 Braunschweig</p>
			<p>Deutschland</p>
			<p>Phone: +4917630629281</p>
			<p>Email: mail@jenskrumsieck.de</p>
			<p>Website: porphystruct.org</p>

			<h4>3. Cookies</h4>
			<p>
				The Internet pages of PorphyStruct use cookies. Cookies are text files that are stored in a
			...
			<p>
				Through the use of cookies, PorphyStruct can provide the users of this website with more
			...
			<p>
				The website of PorphyStruct collects a series of general data and information when a data
				subject or automated system calls up the website. This general data and information are
				stored in the server log files. Collected may be (1) the browser types and versions used,
			...
			<p>
				When using these general data and information, PorphyStruct does not draw any conclusions
				...
				prosecution in case of a cyber-attack. Therefore, PorphyStruct analyzes anonymously
			...
			<ul style="list-style: none;">
				...
				<li>
					...
					<p>
						...
						erasure of personal data stored by PorphyStruct, he or she may, at any time, contact any
						employee of the controller. An employee of PorphyStruct shall promptly ensure that the
					...
					<p>
						...
						those personal data, as far as processing is not required. An employees of PorphyStruct
				...
				<li>
					...
					<p>
						...
						restriction of the processing of personal data stored by PorphyStruct, he or she may at
						any time contact any employee of the controller. The employee of PorphyStruct will
				...
				<li>
					...
					<p>
						...
						contact any employee of PorphyStruct.
					</p>
				</li>
				<li>
					...
					<p>
						PorphyStruct shall no longer process the personal data in the event of the objection,
					...
					<p>
						If PorphyStruct processes personal data for direct marketing purposes, the data subject
						...
						such direct marketing. If the data subject objects to PorphyStruct to the processing for
						direct marketing purposes, PorphyStruct will no longer process the personal data for
						these purposes.
					</p>
					...
					<p>
						...
						the PorphyStruct for scientific or historical research purposes, or for statistical
					...
					<p>
						...
						the PorphyStruct. In addition, the data subject is free in the context of the use of
						information society services, and notwithstanding Directive 2002/58/EC, to use his or
				...
				<li>
					...
					<p>
						...
						explicit consent, PorphyStruct shall implement suitable measures to safeguard the data
					...
					<p>
						...
						decision-making, he or she may, at any time, contact any employee of PorphyStruct.
					</p>
				</li>
				<li>
					...
					<p>
						...
						at any time, contact any employee of PorphyStruct.
					</p>
				</li>
			</ul>
			...
			<p>
				...
				enable the Internet community to provide personal or business-related information. Facebook
				allows social network users to include the creation of private profiles, upload photos, and
				network through friend requests.
			</p>

			<p>
				The operating company of Facebook is Facebook, Inc., 1 Hacker Way, Menlo Park, CA 94025,
				United States. If a person lives outside of the United States or Canada, the controller is
			...
			<p>
				...
				by the controller and into which a Facebook component (Facebook plug-ins) was integrated,
				the web browser on the information technology system of the data subject is automatically
				prompted to download display of the corresponding Facebook component from Facebook through
				the Facebook component. An overview of all the Facebook Plug-ins may be accessed under
			...
			<p>
				...
				submits a comment, then Facebook matches this information with the personal Facebook user
			...
			<p>
				...
				Facebook during the time of the call-up to our website. This occurs regardless of whether
				the data subject clicks on the Facebook component or not. If such a transmission of
				information to Facebook is not desirable for the data subject, then he or she may prevent
				this by logging off from their Facebook account before a call-up to our website is made.
			</p>
			...
			<p>
				...
				collection, gathering, and analysis of data about the behavior of visitors to websites. A
				web analysis service collects, inter alia, data about the website from which a person has
				come (the so-called referrer), which sub-pages were visited, or how often and for what
				duration a sub-page was viewed. Web analytics are mainly used for the optimization of a
				website and in order to carry out a cost-benefit analysis of Internet advertising.
			</p>

			<p>
				The operator of the Google Analytics component is Google Ireland Limited, Gordon House,
			...
			<p>
				...
				data subject is abridged by Google and anonymised when accessing our websites from a Member
				State of the European Union or another Contracting State to the Agreement on the European
				Economic Area.
			</p>
			...
			<p>
				...
				such as the IP address of the data subject, which serves Google, inter alia, to understand
			...
			<p>
				...
				the processing of this data by Google and the chance to preclude any such. For this purpose,
				...
				is later deleted, formatted, or newly installed, then the data subject must reinstall the
				browser add-ons to disable Google Analytics. If the browser add-on was uninstalled by the
				data subject or any other person who is attributable to their sphere of competence, or is
				disabled, it is possible to execute the reinstallation or reactivation of the browser
				add-ons.
			</p>
			...
			<p>
				...
				prompted to the download of a display of the corresponding Instagram component of Instagram.
			...
			<p>
				...
				our website provided that the data subject is logged in at Instagram at the time of the call
				to our website. This occurs regardless of whether the person clicks on the Instagram button
				or not. If such a transmission of information to Instagram is not desirable for the data
				subject, then he or she can prevent this by logging off from their Instagram account before
			...
			<p>
				...
				connect and to make new business contacts. Over 400 million registered people in more than
				200 countries use LinkedIn. Thus, LinkedIn is currently the largest platform for business
			...
			<p>
				...
				View, CA 94043, UNITED STATES. For privacy matters outside of the UNITED STATES LinkedIn
				Ireland, Privacy Policy Issues, Wilton Plaza, Wilton Place, Dublin 2, Ireland, is
				responsible.
			</p>
			...
			<p>
				...
				our website, provided that the data subject is logged in at LinkedIn at the time of the
				call-up to our website. This occurs regardless of whether the person clicks on the LinkedIn
				button or not. If such a transmission of information to LinkedIn is not desirable for the
				data subject, then he or she may prevent this by logging off from their LinkedIn account
			...
			<p>
				...
				short messages are available for everyone, including those who are not logged on to Twitter.
				The tweets are also displayed to so-called followers of the respective user. Followers are
				other Twitter users who follow a user's tweets. Furthermore, Twitter allows you to address a
			...
			<p>
				...
				procedure, Twitter gains knowledge of what specific sub-page of our website was visited by
				the data subject. The purpose of the integration of the Twitter component is a
			...
			<p>
				...
				website, provided that the data subject is logged in on Twitter at the time of the call-up
				to our website. This occurs regardless of whether the person clicks on the Twitter component
				or not. If such a transmission of information to Twitter is not desirable for the data
				subject, then he or she may prevent this by logging off from their Twitter account before a
			...
			<p>
				...
				social network that enables users to connect with existing business contacts and to create
				new business contacts. The individual users can create a personal profile of themselves at
				XING. Companies may, e.g. create company profiles or publish jobs on XING.
			</p>
			...
			<p>
				...
				to download a display of the corresponding XING component of XING. Further information about
				the XING plug-in the may be accessed under https://dev.xing.com/plugins. During the course
				of this technical procedure, XING gains knowledge of what specific sub-page of our website
			...
			<p>
				...
				information is collected through the XING component and associated with the respective XING
				account of the data subject. If the data subject clicks on the XING button integrated on our
				Internet site, e.g. the "Share"-button, then XING assigns this information to the personal
			...
			<p>
				...
				website. This occurs regardless of whether the person clicks on the XING component or not.
				If such a transmission of information to XING is not desirable for the data subject, then he
				or she can prevent this by logging off from their XING account before a call-up to our
				website is made.
			</p>
			...
			<p>
				...
				personal data by XING. In addition, XING has published privacy notices for the XING share
				button under https://www.xing.com/app/share?op=data_protection.
			</p>
			...
			<p>
				...
				video portal that enables video publishers to set video clips and other users free of
				charge, which also provides free viewing, review and commenting on them. YouTube allows you
				to publish all kinds of videos, so you can access both full movies and TV broadcasts, as
			...
			<p>
				With each call-up to one of the individual pages of this Internet site, which is operated by
				the controller and on which a YouTube component (YouTube video) was integrated, the Internet
				browser on the information technology system of the data subject is automatically prompted
			...
			<p>
				...
				subject has visited our website, if the data subject at the time of the call to our website
				is logged in on YouTube; this occurs regardless of whether the person clicks on a YouTube
				video or not. If such a transmission of this information to YouTube and Google is not
				desirable for the data subject, the delivery may be prevented if the data subject logs off
			...
			<p class="mt-5">
				...
				<a href="https://dg-datenschutz.de/">Prof. Dr. h.c. Heiko Jonny Maniero</a>
				from the German Association for Data Protection and
				<a href="https://www.wbs-law.de/" rel="nofollow">Christian Solmecke</a> from WBS law.
			</p>
		</div>
	</Wrapper>
</section>
