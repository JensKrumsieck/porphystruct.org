    ...
    <div class="container">
      <div class="columns">
        <div class="footer-logo logo column is-5">
          <a href="/">
            <img src="/img/logo.svg" style="height: 34px;" alt="logo" />
          </a>
          ...
          <p class="small made has-text-light m-t-5">
            ...
            >
              <rect width="753.578" height="508.953" x="0" y="0" fill="rgb(0, 0, 0)" />
              <rect
                width="753.578"
                height="339.30199999999996"
                x="0"
                y="169.65099999999998"
                fill="rgb(198, 12, 48)"
              />
              <rect
                width="753.578"
                height="169.65099999999998"
                x="0"
                y="339.30199999999996"
                fill="rgb(253, 200, 47)"
              />
            </svg>
            Made in Germany
          ...
          <ul class="menu-list">
            ...
            <li>
              <a
                ...
                target="_blank"
              >
                <b-icon pack="fa" icon="cloud-download-alt" />Download
              </a>
            </li>
          </ul>
        </div>
...
.footer-menu {
  ...
  .menu-list a.is-active {
    background-color: darken(#29384d, 10%);
  }
}
